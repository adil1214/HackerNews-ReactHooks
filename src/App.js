...
const App = () => {
	...
	return (
		<div className="container max-w-md mx-auto p-4 m-2 bg-green-dark shadow-lg rounded">
			<img src="https://is1-ssl.mzstatic.com/image/thumb/Purple128/v4/61/e7/6d/61e76d36-7b44-7173-2540-412605060935/AppIcon-1x_U007emarketing-85-220-0-6.png/246x0w.jpg" alt="Hacker News" className="float-right h-16" />
